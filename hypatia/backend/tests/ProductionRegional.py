...
from hypatia.backend.tests.TestSettings import (
    SingleNodeOperationProductionTestSettings,
    SingleNodePlanningProductionTestSettings,
    MultiNodeOperationProductionTestSettings,
    MultiNodePlanningProductionTestSettings
)
...
class TestProductionSingleRegionOperation(unittest.TestCase):
    '''
    ...
    def __init__(self, *args, **kwargs):
        super(TestProductionSingleRegionOperation, self).__init__(*args, **kwargs)
...
# class TestProductionMultiRegionOperation(unittest.TestCase):
#     '''
#     The scenario used in the test is:
...
#     def __init__(self, *args, **kwargs):
#         super(TestProductionMultiRegionOperation, self).__init__(*args, **kwargs)
        
#     # Checks if the model correctly tracks the emission generated by the model solution
#     def test_max_production(self):
        
#         #load the sets from TestSettings.py
#         example_settings = MultiNodeOperationProductionTestSettings()
#         settings = ModelSettings(
#             ModelMode.Operation,
#             example_settings.global_settings,
#             example_settings.regional_settings,
...
#         # Increment the residual capacity for all techs
#         regional_parameters["reg2"]["tech_residual_cap"].loc[:, (slice(None), ["Elec_import"])] += 8760
#         regional_parameters["reg1"]["tech_residual_cap"].loc[:, (slice(None), ["PV_park"])] += 8760
#         regional_parameters["reg2"]["tech_residual_cap"].loc[:, (slice(None), ["PV_park"])] += 8760

#         trade_parameters["line_residual_cap"].loc[:, (slice(None), ["Elec"])] = 8760
...
#         regional_parameters["reg2"]["tech_var_cost"].loc[:, (slice(None), ["PV_park"])] += 10

#         # Increment the Emission production for the NG transformation technologies
#         regional_parameters["reg1"]["tech_max_production"].loc[:,(slice(None), ["PV_park"])] -= 1e20
#         regional_parameters["reg1"]["tech_max_production"].loc[:,(slice(None), ["PV_park"])] += 4000
#         regional_parameters["reg2"]["tech_max_production"].loc[:,(slice(None), ["PV_park"])] -= 1e20
#         regional_parameters["reg2"]["tech_max_production"].loc[:,(slice(None), ["PV_park"])] += 4000
...
#         self.assertEqual(round(np.sum(supply_technology_use_reg1["PV_park"].values),5), [4000])
#         self.assertEqual(round(np.sum(supply_technology_use_reg2["PV_park"].values),5), [4000])
#         self.assertEqual(round(np.sum(supply_technology_use_reg2["Elec_import"].values),5), [760])
...
#         # Increment the Emission production for the NG transformation technologies
#         regional_parameters["reg1"]["tech_max_production_share"].loc[:,(slice(None), ["PV_park"])] -= 0.9
#         regional_parameters["reg2"]["tech_max_production_share"].loc[:,(slice(None), ["PV_park"])] -= 0.9
...
#         self.assertEqual(round(np.sum(supply_technology_use_reg1["PV_park"].values),5), [876])
#         self.assertEqual(round(np.sum(supply_technology_use_reg2["PV_park"].values),5), [876])
...
#         # Increment the cost for Heat_import and Elec_import so it is better to fulfil the demand using NG
#         regional_parameters["reg1"]["tech_var_cost"].loc[:, (slice(None), ["PV_park"])] += 100
#         regional_parameters["reg2"]["tech_var_cost"].loc[:, (slice(None), ["PV_park"])] += 10000

#         # Increment the Emission production for the NG transformation technologies
#         regional_parameters["reg1"]["tech_min_production"].loc[:,(slice(None), ["PV_park"])] += 4000
#         regional_parameters["reg2"]["tech_min_production"].loc[:,(slice(None), ["PV_park"])] += 4000
...
#         # Increment the cost for Heat_import and Elec_import so it is better to fulfil the demand using NG
#         regional_parameters["reg1"]["tech_var_cost"].loc[:, (slice(None), ["PV_park"])] += 10
#         regional_parameters["reg2"]["tech_var_cost"].loc[:, (slice(None), ["PV_park"])] += 1000

#         # Increment the Emission production for the NG transformation technologies
#         regional_parameters["reg1"]["tech_min_production_share"].loc[:,(slice(None), ["PV_park"])] += 0.1
#         regional_parameters["reg2"]["tech_min_production_share"].loc[:,(slice(None), ["PV_park"])] += 0.1
