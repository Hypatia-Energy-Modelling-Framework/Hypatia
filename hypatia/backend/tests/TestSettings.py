...
class MultiNodeOperationRampingTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
class SingleNodePlanningRampingTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
class MultiNodePlanningRampingTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
'''
Min/max production Tests settings
'''
class SingleNodeOperationProductionTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
            ...
            "Technologies_glob": pd.DataFrame(
                np.array([
                    ['PV_park', 'Photovoltaic park', "Supply", "GW", "GWh"],
                    ['Elec_import', 'Import of Electricity', "Supply", "GW", "GWh"],
                    ['CHP', 'Combined Heat and Power Plant', "Conversion_plus", "GW", "GWh"],
                    ['Heat_import', 'Import of Heat', "Supply", "GW", "GWh"],
                    ['Elec_demand', 'Electricty demand', "Demand", "GWh", "GWh"],
                    ['Heat_demand', 'Heat demand', "Demand", "GWh", "GWh"]
                ]),
    ...
    def regional_settings(self):
        return {
            'reg1': {
                ...
                np.array([
                    ['PV_park', 'Photovoltaic park', "Supply"],
                    ['CHP', 'Combined Heat and Power Plant', "Conversion_plus"],
                    ['Elec_import', 'Import of Electricity', "Supply"],
                    ['Heat_import', 'Import of Heat', "Supply"],                    
                    ['Elec_demand', 'Electricty demand', "Demand"],
                    ['Heat_demand', 'Heat demand', "Demand"]
...
class MultiNodeOperationProductionTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
class SingleNodePlanningProductionTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
class MultiNodePlanningProductionTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
'''
Renewable penetration Tests settings
'''
class SingleNodeOperationResPenetrationTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
...
class SingleNodePlanningResPenetrationTestSettings(ExampleSettings):
    @property
    def global_settings(self):
        global_settings =  {
            "Regions": pd.DataFrame(
